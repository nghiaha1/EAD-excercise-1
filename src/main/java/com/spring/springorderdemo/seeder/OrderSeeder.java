    ...
    private LocalDateTime calculateOrderCreatedTime(OrderSeederByTime orderSeederByTime) {
        ...
        switch (orderSeederByTime.getSeedTypeByTime()) {
            case YEAR:
                ...
                tempHour = orderSeederByTime.getHour();
                tempMinute = orderSeederByTime.getMinute();
